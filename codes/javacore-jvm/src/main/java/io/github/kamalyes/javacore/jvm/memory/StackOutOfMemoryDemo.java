 ...
 * VM Args: -Xss512k
 * <p>
 * Linux Test Cli: nohup java -verbose:gc -Xss512k -cp target/javacore-jvm-1.0.1.jar io.github.kamalyes.javacore.jvm.memory.StackOutOfMemoryDemo >> output.log 2>&1 &
 *
