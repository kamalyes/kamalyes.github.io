...
public class BeanLifeTests {
    ...
    public void testBeanLifeByAnnotation(CapturedOutput capturedOutput) {
        ...
        List<String> lines = Arrays.asList("setBeanName -> beanLifecycle",
            ...
            "afterPropertiesSet",
            "<bean> init-method",
            "postProcessBeforeInitialization -> io.github.kamalyes.spring.core.bean.BeanLifeTests.ORIGINAL",
            "postProcessAfterInitialization -> io.github.kamalyes.spring.core.bean.BeanLifeTests.ORIGINAL",
            "setBeanFactory -> beanFactory",
            "setApplicationContext -> applicationContext",
            "afterPropertiesSet",
            "<bean> init-method",
