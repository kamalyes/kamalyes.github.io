...
public class BeanInstantiationSpecialTests {
    ...
    public void testBeanInstantiationByServiceLoader() {
        ...
        // 1. 添加 /META-INF/services/io.github.kamalyes.spring.core.bean.life.UserFactory 文件
        // 2. 文件中指定 UserFactory 的实现类（io.github.kamalyes.spring.core.bean.life.DefaultUserFactory）
        // 3. 获取 ServiceLoader
