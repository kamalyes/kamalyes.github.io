...
import io.github.kamalyes.springboot.security.handler.CustomAuthenticationFailureHandler;
import io.github.kamalyes.springboot.security.handler.CustomAuthenticationSuccessHandler;
import io.github.kamalyes.springboot.security.service.LdapUtil;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final AuthenticationManagerBuilder auth) throws Exception {
        auth.ldapAuthentication()
            ...
            .contextSource()
            .url("ldap://172.22.6.12:10389/dc=kamalyes,dc=github,dc=io")
            .and()
            .passwordCompare()
