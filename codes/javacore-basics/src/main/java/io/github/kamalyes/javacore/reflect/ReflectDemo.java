...
public class ReflectDemo {
    ...
    public static void testGetClassObject() throws Exception {
        // 方法一
        Class<?> clazz1 = Class.forName("io.github.kamalyes.javacore.reflect.ReflectDemo$Person");
    ...
    public static void testGetObjectByClass() throws Exception {
        Class<?> clazz = Class.forName("io.github.kamalyes.javacore.reflect.ReflectDemo$Person");
