...
import static io.github.kamalyes.javatech.reflections.ReflectionsQueryTest.equalTo;
...
public class ReflectionsExpandSupertypesTest {
    ...
    private final FilterBuilder inputsFilter = new FilterBuilder()
        .includePattern("io\\.github\\.kamalyes\\.javatech\\.reflections\\.ReflectionsExpandSupertypesTest\\$ExpandTestModel\\$Scanned\\$.*");
