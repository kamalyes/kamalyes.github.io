package io.github.kamalyes.javatech.java;
...
public class JavaParserTest {
    ...
    final String FILE_PATH = "src/test/java/io/github/kamalyes/javatech/java/samples/ReversePolishNotation.java";
    ...
    @CsvSource({ "src/test/java/io/github/kamalyes/javatech/java/samples/CodeEnum.java",
        "src/test/java/io/github/kamalyes/javatech/java/samples/WebSocketMsgType.java",
        "src/test/java/io/github/kamalyes/javatech/java/samples/CaptchaTypeEnum.java",
        "src/test/java/io/github/kamalyes/javatech/java/samples/CodeBiEnum.java" })
    ...
    public void getTypeOfReference() throws FileNotFoundException {
        final String FILE_PATH = "src/test/java/io/github/kamalyes/javatech/java/samples/Bar.java";
    ...
    public void resolveMethodCalls() throws FileNotFoundException {
        final String FILE_PATH = "src/test/java/io/github/kamalyes/javatech/java/samples/A.java";
