...
public class ConfigurationBuilderTest {
    ...
    public void buildForConfig() {
        assertConfig(ConfigurationBuilder.build("io.github.kamalyes.javatech.reflections"),
            ClasspathHelper.forPackage("io.github.kamalyes.javatech.reflections"),
            new FilterBuilder().includePackage("io.github.kamalyes.javatech.reflections"));
