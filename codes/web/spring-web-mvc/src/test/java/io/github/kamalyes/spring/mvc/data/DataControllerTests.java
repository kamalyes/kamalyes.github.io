package io.github.kamalyes.spring.mvc.data;

import io.github.kamalyes.spring.mvc.AbstractContextControllerTests;
    ...
    public void group() throws Exception {
        this.mockMvc.perform(get("/data/group?param1=foo&param2=bar&param3=baz"))
                    .andExpect(content().string(
                        startsWith("Obtained parameter group io.github.kamalyes.spring.mvc.data.JavaBean")));
    }
