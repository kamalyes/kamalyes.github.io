package io.github.kamalyes.spring.config;
...
@EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = { "io.github.kamalyes" })
public class SpringSwaggerConfiguration implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("Kamalyes", "https://github.com/kamalyes", "forbreak@163.com");
        return new ApiInfoBuilder().title("开放 REST API 接口")
                                   .description("Spring + Swagger 自动生成开放 REST API 接口")
                                   .version("1.0.0")
                                   .termsOfServiceUrl("https://github.com/kamalyes")
                                   .contact(contact)
                                   .build();
    }
