...
<p align="center">
<img src="https://fastly.jsdelivr.net/gh/kamalyes/image_store@master/blog/qrcode.zdqv9mlfc0g.jpg" width="200">
</p>
...
* [ES5教程](https://wangdoc.com/javascript/) kamalyes的JS教程
* [Bash 脚本教程](https://wangdoc.com/bash/) kamalyes编写
...
- [FC在线模拟器(小霸王游戏机)](https://game.yuyanqing.cn/) 童年回忆
...
- [到账语音生成器](https://zfb.yuyanqing.cn/) 支付宝到账1亿元
