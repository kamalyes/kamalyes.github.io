...
```markdown
![其他仓库的图片1](https://github.com/kamalyes/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2](https://raw.githubusercontent.com/kamalyes/image_store/master/blog/md_logo.png)

```



![其他仓库的图片](https://github.com/kamalyes/vue-music/raw/master/src/common/image/default.png)
