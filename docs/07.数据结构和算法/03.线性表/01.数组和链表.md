...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320115848.png)

### 数组的删除

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320115859.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320152607.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320174908.png)

（2）将 `cur` 的 `next` 字段链接到 `prev` 的下一个结点 `next` ；

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320174919.png)

（3）将 `prev` 中的 `next` 字段链接到 `cur` 。

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320174932.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320174953.png)

（2）接下来链接 `prev` 到 `cur` 的下一个节点 `next` 。

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320175006.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320181150.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320181208.png)

（2）链接 `cur` 与 `prev` 和 `next`，其中 `next` 是 `prev` 原始的下一个节点；

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320181303.png)

（3）用 `cur` 重新链接 `prev` 和 `next`。

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220320181504.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220322190534.png)

#### 循环双链表

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20220322190423.png)
