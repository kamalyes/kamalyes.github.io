...
> :point_right: [完整示例源码](https://github.com/kamalyes/kamalyes.github.io/tree/master/codes/javadb/javadb-sqlite)
...
>
> :point_right: 扩展阅读：[标准 SQL 基本语法](https://github.com/kamalyes/blog/blob/master/docs/database/sql/sql.md)
