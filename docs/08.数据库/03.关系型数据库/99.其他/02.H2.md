...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/h2/h2-console.png)

点击 **Connect** ，可以进入操作界面：

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/h2/h2-console-02.png)
