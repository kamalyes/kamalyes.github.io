...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库事务.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库并发一致性-丢失修改.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库ACID.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库并发一致性-脏数据.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库并发一致性-不可重复读.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/database/RDB/数据库并发一致性-幻读.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630153139.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630154606.png)

出现死锁的步骤：

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630154619.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630112600.png)
