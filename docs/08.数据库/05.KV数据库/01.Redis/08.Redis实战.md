...
> 缓存应用的基本原理，请参考 [**缓存基本原理**](https://yuyanqing.cn/arc_design/distributed/分布式缓存.html) 第四 ~ 第六节内容。
...
> 什么是缓存穿透，可以参考：[**缓存基本原理**](https://yuyanqing.cn/arc_design/distributed/分布式缓存.html)
...
> 更多分布式锁的实现方式及细节，请参考：[分布式锁基本原理](https://yuyanqing.cn/pages/40ac64/)
