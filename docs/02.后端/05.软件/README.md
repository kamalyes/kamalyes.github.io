...
> 自从有了 [**IDE**](03.IDE)，写代码从此就告别了刀耕火种的蛮荒时代。
>
> - [Eclipse](03.IDE/02.Eclipse.md) 是久负盛名的开源 Java IDE，我的学生时代一直使用它写 Java。
> - 曾经抗拒从转 [Intellij Idea](03.IDE/01.Intellij.md) ，但后来发现真香，不得不说，确实是目前最优秀的 Java IDE。
> - 你可以在 [vscode](03.IDE/03.VsCode.md) 中写各种语言，只要安装相应插件即可。如果你的项目中使用了很多种编程语言，又懒得在多个 IDE 之间切换，那么就用 vscode 来一网打尽吧。

- [Intellij Idea](03.IDE/01.Intellij.md)
- [Eclipse](03.IDE/02.Eclipse.md)
- [vscode](03.IDE/03.VsCode.md)

### 监控诊断

> [监控/诊断](02.监控诊断) 工具主要用于 Java 应用的运维。通过采集、分析、存储、可视化应用的有效数据，帮助开发者、使用者快速定位问题，找到性能瓶颈。

- [监控工具对比](02.监控诊断/01.监控工具对比.md)
- [CAT](02.监控诊断/02.CAT.md)
- [Zipkin](02.监控诊断/03.Zipkin.md)
- [SkyWalking](02.监控诊断/04.Skywalking.md)
- [Arthas](02.监控诊断/05.Arthas.md)
