...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20220529190340.png)
...
> :bulb: 不了解 Java 序列化方式，可以参考：[Java 序列化](https://yuyanqing.cn/pages/2b2f0f/)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20220529190416.png)
...
```
11:26:33.214 [main] INFO io.github.kamalyes.javacore.container.list.AsList示例 - list:[[I@ae45eb6] size:1 class:class [I
```
