...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/1553752019030.png)
...
Exception in thread "main" java.lang.ArithmeticException: / by zero
	at io.github.kamalyes.javacore.exception.RumtimeExceptionDemo01.main(RumtimeExceptionDemo01.java:6)
```
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/1553752795010.png)
...
```
Exception in thread "main" io.github.kamalyes.javacore.exception.MyExceptionDemo$MyException: 自定义异常
	at io.github.kamalyes.javacore.exception.MyExceptionDemo.main(MyExceptionDemo.java:9)
```
...
java.lang.NoSuchMethodException: java.lang.String.toString(int)
	...
	at io.github.kamalyes.javacore.exception.ThrowsDemo.f1(ThrowsDemo.java:12)
	at io.github.kamalyes.javacore.exception.ThrowsDemo.f2(ThrowsDemo.java:21)
	at io.github.kamalyes.javacore.exception.ThrowsDemo.main(ThrowsDemo.java:30)
```
...
```
Exception in thread "main" io.github.kamalyes.javacore.exception.ExceptionChainDemo$MyException2: 出现 MyException2
	at io.github.kamalyes.javacore.exception.ExceptionChainDemo.f2(ExceptionChainDemo.java:29)
	at io.github.kamalyes.javacore.exception.ExceptionChainDemo.main(ExceptionChainDemo.java:34)
Caused by: io.github.kamalyes.javacore.exception.ExceptionChainDemo$MyException1: 出现 MyException1
	at io.github.kamalyes.javacore.exception.ExceptionChainDemo.f1(ExceptionChainDemo.java:22)
	at io.github.kamalyes.javacore.exception.ExceptionChainDemo.f2(ExceptionChainDemo.java:27)
	... 1 more
```
