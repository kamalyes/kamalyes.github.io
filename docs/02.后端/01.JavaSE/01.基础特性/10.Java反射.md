...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/xmind/Java反射.svg)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/1553611895164.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/xmind/Java代理.svg)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/1553614585028.png)
...
Before method
Call Method: public abstract void io.github.kamalyes.javacore.reflect.InvocationHandlerDemo$Subject.hello(java.lang.String)
Hello  World
After method

Before method
Call Method: public abstract java.lang.String io.github.kamalyes.javacore.reflect.InvocationHandlerDemo$Subject.bye()
Goodbye
After method
...
```java
public abstract void io.github.kamalyes.javacore.reflect.InvocationHandlerDemo$Subject.hello(java.lang.String)
public abstract java.lang.String io.github.kamalyes.javacore.reflect.InvocationHandlerDemo$Subject.bye()
```
