...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/jvm/jvm-memory-runtime-data-area.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/jvm/jvm-stack.png!w640)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/jvm/jvm-native-method-stack.gif!w640)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/jvm/jvm-heap.gif!w640)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630094250.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630094329.png)

（5）执行方法。启动 main 线程，执行 main 方法，开始执行第一行代码。此时堆内存中会创建一个 student 对象，对象引用 student 就存放在栈中。

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630094651.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/snap/20200630094714.png)
