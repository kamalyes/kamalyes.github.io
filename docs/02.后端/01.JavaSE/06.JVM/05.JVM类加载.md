...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20200617145849.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20200617115110.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20200617115936.png)
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/jvm/jmm-类加载-双亲委派.png" width="500" />
</div>
...
java.lang.UnsatisfiedLinkError: no NoLib in java.library.path
	...
	at io.github.kamalyes.javacore.jvm.classloader.exception.UnsatisfiedLinkErrorDemo.<clinit>(UnsatisfiedLinkErrorDemo.java:12)
```
...
```java
Exception in thread "main" java.lang.ClassCastException: java.lang.Object cannot be cast to io.github.kamalyes.javacore.jvm.classloader.exception.ClassCastExceptionDemo$EmptyClass
	at io.github.kamalyes.javacore.jvm.classloader.exception.ClassCastExceptionDemo.main(ClassCastExceptionDemo.java:11)
```
