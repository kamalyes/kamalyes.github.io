...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/concurrent/aqs_1.png)
...
![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/concurrent/aqs_2.png)

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/concurrent/aqs_3.png)

详细流程可以用下图来表示，请结合源码来理解（一图胜千言）：

![img](https://cdn.jsdelivr.net/gh/kamalyes/image-bed@master/col/java/javacore/concurrent/aqs_4.png)
