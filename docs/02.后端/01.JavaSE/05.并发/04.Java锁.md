...
> 💡 `synchronized` 的用法和原理可以参考：[Java 并发基础机制 - synchronized](https://yuyanqing.cn/pages/2c6488/#%E4%BA%8Csynchronized) 。
>
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/concurrent/aqs_1.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/concurrent/aqs_2.png)

![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/concurrent/aqs_3.png)

详细流程可以用下图来表示，请结合源码来理解（一图胜千言）：

![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javacore/concurrent/aqs_4.png)
