...
```
    ...
    2018年 07月 03日 星期二 15:59:00 CST
...
```
    ...
    chmod ugo+rwx directory1 设置目录的所有人(u)、群组(g)以及其它人(o)以读（r ）、写(w)和执行(x)的权限
    chmod go-rwx directory1 删除群组(g)与其它人(o)对目录的读写执行权限
