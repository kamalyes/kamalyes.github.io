...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/tomcat.png)
...
>
> [**示例项目**](https://github.com/kamalyes/JavaStack/tree/master/codes/javatool/server)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/tomcat-intellij-run-config.png)

> **说明**
>
> 个人认为这个插件不如 Eclipse 的 Tomcat 插件好用，Eclipse 的 Tomcat 插件支持对 Tomcat xml 配置文件进行配置。而这里，你只能自己去 Tomcat 安装路径下修改配置文件。

文中的嵌入式启动示例可以参考[**我的示例项目**](https://github.com/kamalyes/JavaStack/tree/master/codes/javatool/server)

## 3. Tomcat 架构

![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201113193431.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201111093124.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201111101440.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201027091819.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201113185929.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201113192022.jpg)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/Pipeline与Valve.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/请求处理过程.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201118145455.png)
...
![img](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20201118105012.png)

#### 4.3.1. 请求处理过程

<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/请求处理过程.png" width="600">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/connector.png" width="600">
</div>

#### 4.4.1. 阻塞 IO

<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/阻塞IO.png" width="600">
</div>

#### 4.4.2. 非阻塞 IO

<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/非阻塞IO.png" width="600">
</div>

#### 4.4.3. IO 多路复用

<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/IO多路复用.png" width="600">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/Tomcat各类Connector对比.jpg" width="500">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/NIO处理相关类.jpg" width="500">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/传统Servlet处理流程.png" >
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/kamalyes/image-bed/master/col/java/javaweb/tools/tomcat/异步Servlet处理流程.png" >
</div>
