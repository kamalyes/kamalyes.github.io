/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/kamalyes/vuepress-blog/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'kamalyes/vuepress-blog', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        'kamalyes | <a href="https://github.com/kamalyes/vuepress-blog/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          repo: 'kamalyes.github.io', // GitHub 仓库
