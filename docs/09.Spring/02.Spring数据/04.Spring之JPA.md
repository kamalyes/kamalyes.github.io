...
@EntityScan("io.github.kamalyes.springboot.data.jpa")
// 【可选】指定扫描的 Repository 目录，如果不指定，会扫描全部目录
@EnableJpaRepositories(basePackages = {"io.github.kamalyes.springboot.data.jpa"})
...
![](https://raw.githubusercontent.com/kamalyes/image-bed/master/snap/20230123160810.png)
