...
> 完整示例：[spring-boot-data-jdbc](https://github.com/kamalyes/kamalyes.github.io/tree/master/codes/data/spring-boot-data-jdbc)
...
> 完整示例：[spring-boot-data-jdbc-multi-datasource](https://github.com/kamalyes/kamalyes.github.io/tree/master/codes/data/spring-boot-data-jdbc-multi-datasource)
...
```
21:16:55.654 [main] [INFO ] i.g.d.s.d.SpringBootDataJdbcMultiDataSourceApplication.printDataSourceInfo - DataSource Url: jdbc:mysql://localhost:3306/spring_tutorial?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false
21:16:55.654 [main] [INFO ] i.g.d.s.d.SpringBootDataJdbcMultiDataSourceApplication.run - Connect to mysql datasource success.

21:16:55.726 [main] [INFO ] i.g.d.s.d.SpringBootDataJdbcMultiDataSourceApplication.printDataSourceInfo - DataSource Url: jdbc:h2:mem:test
21:16:55.726 [main] [INFO ] i.g.d.s.d.SpringBootDataJdbcMultiDataSourceApplication.run - Connect to h2 datasource success.
```
