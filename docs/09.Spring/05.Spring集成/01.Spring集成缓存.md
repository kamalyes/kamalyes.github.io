...
<beans xmlns="http://www.springframework.org/schema/beans"
  ...
  <context:component-scan base-package="io.github.kamalyes.spring.cache"/>
...
我的示例代码地址：[spring-tutorial-integration-cache](https://github.com/kamalyes/kamalyes.github.io/tree/master/spring-tutorial/spring-tutorial-integration/spring-tutorial-integration-cache)
